...
export default function Navbar() {
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark position-absolute w-100" style={{zIndex : "2"}}>
            <div className="container-fluid">
                ...
                <div className="mx-5" id="navbarSupportedContent">
                    <ul className="navbar-nav d-flex flex-row">
                        ...
                        <li className="nav-item me-4">
                            <Link className="nav-link active fs-5" aria-current="page" to="/">Booking</Link>
                        </li>
                        <li className="nav-item me-4">
